...
import 'package:tours/progress_hud.dart';
import 'package:tours/utils/google_place_util.dart';
import 'package:tours/utils/map_util.dart';
...
class _MapScreenState extends State<MapScreen>
  ...
  @override
  updateScreen(Map<String, double> currentLocation) async {
    ...
    googlePlaces.updateLocation(myCurrentLocation['latitude'], myCurrentLocation['longitude']);
    setState(() {});
  }
