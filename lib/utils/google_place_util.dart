...
import 'package:tours/flutter_google_places_autocomplete.dart';
...
class GooglePlaces {
  ...
  GoogleMapsPlaces _places =
      new GoogleMapsPlaces(apiKey:"AIzaSyAxdsjrUCIccxpeEQz_BaJyoppiA5BP_t4");
  Location location;
  ...
  Future findPlace(BuildContext context) async {
    Prediction p = await showGooglePlacesAutocomplete(
      context: context,
      location: location,
      apiKey: "AIzaSyAxdsjrUCIccxpeEQz_BaJyoppiA5BP_t4",
      onError: (res) {
